// ignore_for_file: unused_import, file_names, library_private_types_in_public_api, curly_braces_in_flow_control_structures, sort_child_properties_last
...
class VerticalTabs extends StatefulWidget {
  ...
  final Color sideBackgroundColor;
  ...
  const VerticalTabs(
      ...
      this.indicatorColor = const Color(0xFF852856),
      this.disabledChangePageFromContentView = false,
      this.contentScrollAxis = Axis.horizontal,
      this.selectedTabBackgroundColor = const Color(0x0D000000),
      this.tabBackgroundColor = const Color(0xFFF9FBFC),
      this.sideBackgroundColor = const Color(0xFFF9FBFC),
      this.borderColor = const Color(0xFFEEEDF2),
      this.selectedTabTextStyle = const TextStyle(color: Color(0xFF852856)),
      this.tabTextStyle = const TextStyle(color: Color(0xFF143340)),
      this.changePageCurve = Curves.easeInOut,
      this.changePageDuration = const Duration(milliseconds: 100),
      this.tabsShadowColor = const Color(0x1A000000),
...
class _VerticalTabsState extends State<VerticalTabs>
  ...
  Widget build(BuildContext context) {
    Border border =
        Border(right: BorderSide(width: 2, color: widget.borderColor));
    if (widget.direction == TextDirection.rtl) {
      border = Border(left: BorderSide(width: 2, color: widget.borderColor));
    }
                  ...
                  Material(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: widget.sideBackgroundColor,
                        border: border,
                        boxShadow: [
                          BoxShadow(
                            color: widget.tabsShadowColor,
                            spreadRadius: 1,
                            blurRadius: 5,
                            offset: const Offset(
